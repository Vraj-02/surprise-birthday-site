...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Happy Birthday, Queen! 🎉" },
      { name: "description", content: "A very silly, very serious birthday tribute." },
    ],
    links: [
    ...
    <main className="relative overflow-hidden">
      ...
      <section className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 pt-16 pb-24 text-center">
        ...
        <h1 className="mt-4 text-6xl md:text-8xl font-bold leading-[0.95] tracking-tight">
          It's HER <span className="text-primary">birthday</span> 🎂
        </h1>
        <p className="mt-6 max-w-2xl text-lg md:text-xl text-muted-foreground">
          A scientifically approved website to celebrate the most fabulous, slightly chaotic,
          allegedly-still-in-her-twenties human on the planet.
        </p>
